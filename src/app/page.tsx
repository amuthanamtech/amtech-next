                    ...
                    {slideContent.map((slide, index) => (
                        <SwiperSlide key={index}>
                            <div className="relative w-full h-full">
                                ...
                                <div className="absolute inset-0 bg-black/40 flex items-center justify-center md:justify-end px-10 md:px-10 py-6 ">
                                    <div className="text-white w-full md:max-w-md text-center md:text-right space-y-4 overflow-hidden mx-[300px]">
                                        <h1 className="text-2xl  lg:text-5xl font-bold break-words">
                                            {slide.title}
                                        </h1>
                                        <p className="text-sm md:text-lg lg:text-xl break-words">
                                            {slide.description}
                                        </p>
